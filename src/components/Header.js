...
const Header = () => {
  ...
  const NavLink = ({ path, text }) => {
    return <li className="menu-list-item--left">
      <a href={path} className={isSticky ? 'menu-link isDark': 'menu-link '}>{text}</a>
    </li>
  }


  return <header>
    <div className={isSticky ? 'menu-panel sticky' : 'menu-panel'} ref={menuRef}>
      <div className={isSticky ? 'menu-panel-outer isDark' : 'menu-panel-outer '}>
        <div className="menu-panel-inner">
          <nav className="navbar">
            <ul className="menu-list">
              <li className="menu-list-item--left">
                <a href="/" className={isSticky ? 'menu-link isDark active': 'menu-link active'}>Events</a>
              </li>
              <li className="menu-list-item--left">
                <a href="/" className={isSticky ? 'menu-link isDark': 'menu-link '}>rankings</a>
              </li>
              <li className="menu-list-item--left">
                <a href="/" className={isSticky ? 'menu-link isDark': 'menu-link '}>athletes</a>
              </li>
              <li className="menu-list-item--left">
                <a href="/" className={isSticky ? 'menu-link isDark': 'menu-link '}>news</a>
              </li>
              <li className="menu-list-item--home">
                <a href="/" className={isSticky ? 'menu-link isDark': 'menu-link '}>
              ...
              <li className="menu-list-item--right is-pushed">
                <a href="/" className={isSticky ? 'menu-link isDark': 'menu-link '}>videos</a>
              </li>
              <li className="menu-list-item--right">
                <a href="/" className={isSticky ? 'menu-link isDark': 'menu-link '}>connect</a>
              </li>
              <li className="menu-list-item--right">
                <a href="/" className={isSticky ? 'menu-link isDark': 'menu-link '}>watch</a>
              </li>
              <li className="menu-list-item--right">
                <a href="/" className={isSticky ? 'menu-link isDark': 'menu-link '}>shop</a>
              </li>
            </ul>
          </nav>
        </div>
